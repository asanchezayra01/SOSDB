...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `organization_create`(IN name varchar(20), IN description varchar(50), IN privacy varchar(10), IN requirements varchar(10))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `user_register`(IN password varchar(20), IN email varchar(50), IN name varchar(20), IN user_name varchar(20) )
BEGIN

     INSERT users (password, email, name, user_name, privacy)
     VALUES (password, email, name, user_name, "PUBLIC");
